...
//
//     this.starSize = 24.0,
//     this.filledColor = const Color(0xFF695F9B),
//     this.emptyColor = Colors.grey,
...
//
// class _StarRatingState extends State<StarRating> {
//   void _updateRating(BusinessDirectoryProvider provider, double newRating) {
//     print("Star clicked: $newRating"); // Debugging
...
//         double rating = value.rating; // Get rating from provider
//
//         return Row(
//           mainAxisSize: MainAxisSize.min,
//           children: [
...
//                   return GestureDetector(
//                     onTap: () {
//                       print("Tapped on star: ${index + 1.0}"); // Debugging
//                       _updateRating(value, index + 1.0);
//                     },
//                     child: Icon(
//                       starValue >= 1 ? Icons.star : Icons.star_border,
//                       size: widget.starSize,
//                       color: starValue >= 1 ? widget.filledColor : widget.emptyColor,
//                     ),
//                   );
//
//
...
//               child: Text(
//                 rating.toStringAsFixed(1), // Show rating with 1 decimal
//                 style: GoogleFonts.nunito(
//                   fontSize: widget.starSize * 0.8,
//                   fontWeight: FontWeight.bold,
//                   color: widget.filledColor,
//                 ),
//               ),
...
// }
//
// // Clipper for partially filled stars
// class StarHalfClipper extends CustomClipper<Rect> {
//   final double fillAmount;
//
//   StarHalfClipper(this.fillAmount);
//
//   @override
//   Rect getClip(Size size) {
