...
class AboutMission extends StatelessWidget {
  const AboutMission({super.key});
    ...
    return Padding(
      ...
      child: Column(
        ...
        children: [
          ...
          Text.rich(
              TextSpan(
                children: getStyledParagraph(LocalStrings.aboutourmission,),
              )
          ),
        ],
      ),
