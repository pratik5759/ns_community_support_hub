...
//                           image: NetworkImage("https://placehold.co/534x409"),
//                           fit: BoxFit.cover,
//                         ),
//                       ),
//                     ),
...
//                               _buildInfoCard('Category', isDropdown: true),
//                               _buildInfoCard('Hours'),
//                               _buildInfoCard('Phone'),
//                               _buildInfoCard('Location'),
//                               _buildInfoCard('Website URL', isLink: true),
//                             ],
//                           ),
//                         ),
...
//   }
//
//   Widget _buildInfoCard(String title, {bool isDropdown = false, bool isLink = false}) {
//     return Container(
                    ...
                    child: Column(
                      children: [
                        _buildInputRow([
                          ...
                          _buildInputField('Category', isDropdown: true,dropdownItems: ['one']),
                        ]),
                        _buildInputRow([
                          _buildInputField('Description', isMultiline: true),
                          Column(
                            children: [
                              _buildInputField('Hours'),
                              SizedBox(height: 16),
                        ...
                        _buildInputRow([
                          ...
                          _buildInputField('Website URL', isLink: true),
                        ]),
                        SizedBox(height: 16),
                        _buildAttachBusinessImage(),
                        SizedBox(height: 16),
