...
//  LatLng? _location;
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        appBar: CustomAppBar(
          scaffoldKey: AppConstants.scaffoldKey,
        ),
            ...
            return SingleChildScrollView(
                child: Column(
                  ...
                  HeroSectionWithPageName(
                    pageName: widget.business.name,
                    onClickableTextTap: () =>
                        context.go(WebRouteNames.businessDirectory),
                  ...
                  await value.submitReview(context, widget.business.id);
                  } else {
